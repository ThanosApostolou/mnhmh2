...
import { SubcategoryContentsEdit } from "./SubcategoryContentsEdit";
...
export class SubcategoryContentsPage extends React.Component<Record<string, never>, SubcategoryContentsPageState> {
    ...
    render(): ReactNode {
        const actions = <AddEditActions disabledEdit={this.state.selectedSubcategoryContent === null} onAddClick={this.onAddClick.bind(this)} onEditClick={this.onEditClick.bind(this)} />;
        return (
            <Grid container direction="column" style={{height: "100%"}}>
                ...
                <SubcategoryContentDataGrid actions={actions} onRowSelected={this.onRowSelected.bind(this)} storagePrefix="subcategorycontents" fetchData={this.state.fetchData}
                ...
                />
                <SubcategoryContentsEdit subcategoryContent={this.state.selectedSubcategoryContent}
